...
class Front:
    ...
    def home(self):
        ...
        if i == 0:
            self.menu_ini()
            i += 1
        self.master.geometry('640x430+250+150')
        self.frame_body.pack_forget()
        self.frame_body = ttk.Frame(self.master)
        self.frame_body.pack()
        self.frame_body.config(relief=RIDGE, padding=(30, 15))
    ...
    def profile(self):
        self.master.geometry('640x540+250+150')
        self.frame_body.pack_forget()
        self.frame_body = ttk.Frame(self.master)
        self.frame_body.pack()
        self.frame_body.config(relief=RIDGE, padding=(30, 15))
    ...
    def edit(self):
        self.master.geometry('640x520+250+150')
        self.frame_body.pack_forget()
        self.frame_body = ttk.Frame(self.master)
        self.frame_body.pack()
        self.frame_body.config(relief=RIDGE, padding=(30, 15))
    ...
    def transaction_history_friend(self, value):
        self.master.geometry('740x560+250+150')
        self.frame_body.pack_forget()
        self.frame_body = ttk.Frame(self.master)
    ...
    def friends(self):
        ...
        while self.friend_set:
            ...
            ttk.Button(scrollable, text=value,
                       command=lambda value=value: pay_friend_interm(value)).pack()
        self.frame_body.pack()
        self.frame_body.config(relief=RIDGE, padding=(30, 15))
        canvas.pack(side="left", fill="both", expand=True)
